const monthYear = document.getElementById("monthYear");
    ...
    document.getElementById("lanjutBtn").addEventListener("click", () => {
      ...
      localStorage.setItem("reservasiTanggal", selectedDate);
      localStorage.setItem("reservasiLokasi", lokasi);
      localStorage.setItem("vaksin", vaksin);
      localStorage.setItem("reservasiJam", jam);
